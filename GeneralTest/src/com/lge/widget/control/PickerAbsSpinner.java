 ...
 */
public abstract class PickerAbsSpinner extends PickerAdapterView<SpinnerAdapter> {
    ...
    public PickerAbsSpinner(Context context) {
        super(context);
        initAbsSpinner();
    }

    public PickerAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PickerAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
    ...
    void recycleAllViews() {
        ...
        final PickerAbsSpinner.RecycleBin recycleBin = mRecycler;
